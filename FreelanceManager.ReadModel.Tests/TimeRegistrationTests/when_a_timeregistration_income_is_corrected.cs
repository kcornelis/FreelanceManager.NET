...
{
    public class when_a_timeregistration_income_is_corrected : Specification
    {
        ...
        {
            _timeregistration.CorrectedIncome.Should().Be(500M);
        }

        [Fact]
        public void should_have_a_corrected_income_message()
        {
            _timeregistration.CorrectedIncomeMessage.Should().Be("Weekend work");
        }
    }
}
