...
namespace FreelanceManager.Web.Api.WorkItem
{
    public class ApiTests
    {
        ...
        public void Create()
        {
            ...
            var response = (string)browser.CreateWorkItem();

            Assert.NotNull((string)response.WorkItem.Id);

            Assert.Equal(client, (string)response.WorkItem.ClientId);
